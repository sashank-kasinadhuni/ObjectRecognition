  ...
  ui (new Ui::PCLViewer)
{
 ...
 //connecting buttons
  ...
  connect (ui->horizontalSlider_X_Angle, SIGNAL (valueChanged (int)), this, SLOT (xAngleSliderValueChanged (int)));
  connect (ui->horizontalSlider_Y_Angle, SIGNAL (valueChanged (int)), this, SLOT (yAngleSliderValueChanged (int)));
  connect (ui->horizontalSlider_Z_Angle, SIGNAL (valueChanged (int)), this, SLOT (zAngleSliderValueChanged (int)));
...
PCLViewer::XYZSliderChanged ()
{
  ...
  float x_angle = (M_PI / 180) * x_rot;
  float y_angle = (M_PI / 180) * y_rot;
  float z_angle = (M_PI / 180) * z_rot;
...
void
PCLViewer::xAngleSliderValueChanged (int value)
{
  x_rot = value;
  XYZSliderChanged();
}
...
void
PCLViewer::yAngleSliderValueChanged (int value)
{
  y_rot = value;
  XYZSliderChanged();
}
...
void
PCLViewer::zAngleSliderValueChanged (int value)
{
  z_rot= value;
  XYZSliderChanged();
}
